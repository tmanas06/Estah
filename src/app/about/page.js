...
export const metadata = {
    ...
    description: 'Learn about the people, purpose, and passion driving Events MVP.',
};
...
export default function AboutPage() {
    return (
        <ComingSoon
            ...
            subtitle="Learn about the people, purpose, and passion driving Events MVP's work across India."
